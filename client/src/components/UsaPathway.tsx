    ...
    <div className="space-y-10">
      ...
      <section id="requirements" aria-labelledby="requirements-heading">
        ...
        <div className="mt-6">
          ...
          <p className="mt-3 rounded-lg bg-secondary/60 p-3 text-xs leading-5 text-muted-foreground">The report images currently shown include Step 1 and Step 3 examples. The latest attachments were screenshots of the website and Step 1 content; send the actual Step 2 CK report image itself and it can be placed here.</p>
        </div>
      </section>
